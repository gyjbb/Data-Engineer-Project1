...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs (song_id varchar primary key, title varchar NOT NULL, artist_id varchar NOT NULL, year int, duration float NOT NULL);
""")
